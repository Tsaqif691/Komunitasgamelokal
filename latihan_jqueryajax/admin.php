...
<head>
  ...
  <title>Komunitas Game Lokal | Admin</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top bg-info-subtle">
    <div class="container">
      <a class="navbar-brand" target="_blank" href=".">Komunitas Game Lokal</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
          ...
          <li class="nav-item">
            <a class="nav-link" href="admin.php?page=gallery">Galerry</a>
          </li>
  ...
  <!-- content end -->
  <!-- footer begin -->
  <footer class="text-center p-4 bg-info-subtle">
    <div>
    ...
    <div>Mohammad Tsaqif Akmal &copy; 2024</div>
  </footer>
  <!-- footer end -->
